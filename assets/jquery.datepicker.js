    ...
    t_jQueryDatepicker.initialize = function () {
        t_jQueryDatepicker.$element.each(function () {
            ...
            var process_start_date = function () {
                ...
                .removeClass('jQueryDatepicker__past_date'); // add this line
     ...
     $datepicker.find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day').each(function () {
         var $day = $(this);
         var day_year = calendar_year;
         var day_month = calendar_month;
         var day_day = parseInt($day.attr('day'));
 
         if (day_year < today_year || (day_year == today_year && day_month < today_month) || (day_year == today_year && day_month == today_month && day_day < today_day)) {
             $day.addClass('jQueryDatepicker__past_date'); // add this line
         }
     });
                $datepicker.find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day')
                           .removeClass('jQueryDatepicker__current_other')
            ...
            data.selectDay = function (params) {
                var selectedDate = new Date(calendar_year, calendar_month - 1, params.day);
